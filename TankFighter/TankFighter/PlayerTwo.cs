...
namespace TankFighter
{
    ...
    public class PlayerTwo
    {
        ...
        public PlayerTwo()
        {
            ...
            health = 3;
            lightTank = new LightTank(20, GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Width - 155, GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Height / 2 - 10);
            heavyTank = new HeavyTank(20, GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Width - 155, GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Height / 2 - 10);
            rangedTank = new RangedTank( 40, GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Width - 155, GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Height / 2 - 10);
            powerupID = 0;
            powerupCounter = 60;
        }
        ...
        public void LoadContent(GraphicsDevice graphics, ContentManager Content)
        {
            ...
            recGarage = new Rectangle(graphics.Viewport.Width - 55, graphics.Viewport.Height / 2 - 25, 50, 100);
            ...
            garageInfo = new Rectangle(graphics.Viewport.Width - 255, graphics.Viewport.Height / 2 - 25, 200, 200);
        ...
        public void garageEntered(int actualTank)
        {
            ...
            GamePadState newStateG = GamePad.GetState(PlayerIndex.Two);
            if (newState.IsKeyDown(Main.keyMap.getKey(2, 7)) && oldState != newState || GamePad.GetState(PlayerIndex.Two).DPad.Up == ButtonState.Pressed && oldStateG != newStateG)
            {
                if (info != 3)
                    info++;
                else
            ...
            if (newState.IsKeyDown(Main.keyMap.getKey(2, 8)) && oldState != newState || GamePad.GetState(PlayerIndex.Two).DPad.Down == ButtonState.Pressed && oldStateG != newStateG)
            {
                if (info != 1)
                    info--;
                else
            ...
            if (Keyboard.GetState().IsKeyDown(Main.keyMap.getKey(2, 9)) || GamePad.GetState(PlayerIndex.Two).Buttons.A == ButtonState.Pressed && oldStateG != newStateG)
            {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            {
                case 1:
                    if (Keyboard.GetState().IsKeyDown(Main.keyMap.getKey(2, 4)) || GamePad.GetState(PlayerIndex.Two).ThumbSticks.Right.X < 0)
                    {
                        lightTank.RotateTurretLeft();
                    }

                    if (Keyboard.GetState().IsKeyDown(Main.keyMap.getKey(2, 5)) || GamePad.GetState(PlayerIndex.Two).ThumbSticks.Right.X > 0)
                    {
                        lightTank.RotateTurretRight();
                    }

                    if (Keyboard.GetState().IsKeyDown(Main.keyMap.getKey(2, 2)) || GamePad.GetState(PlayerIndex.Two).ThumbSticks.Left.X < 0)
                    {
                        lightTank.RotateChassisLeft();
                    }

                    if (Keyboard.GetState().IsKeyDown(Main.keyMap.getKey(2, 3)) || GamePad.GetState(PlayerIndex.Two).ThumbSticks.Left.X > 0)
                    {
                        lightTank.RotateChassisRight();
                    }
                    if (Keyboard.GetState().IsKeyDown(Main.keyMap.getKey(2, 0)) || GamePad.GetState(PlayerIndex.Two).ThumbSticks.Left.Y > 0)
                    {
                    ...
                    else if (Keyboard.GetState().IsKeyDown(Main.keyMap.getKey(2, 1)) || GamePad.GetState(PlayerIndex.Two).ThumbSticks.Left.Y < 0)
                    {
                    ...
                    else if (Keyboard.GetState().IsKeyUp(Main.keyMap.getKey(2, 1)) && Keyboard.GetState().IsKeyUp(Main.keyMap.getKey(2, 0)))
                    {

                        lightTank.engineHeat++;
                    }

                    if (Keyboard.GetState().IsKeyDown(Main.keyMap.getKey(2, 6)) && canfire || GamePad.GetState(PlayerIndex.Two).Triggers.Right == 1.0f)
                    {
                    ...
                    if (Keyboard.GetState().IsKeyUp(Main.keyMap.getKey(2, 6)))
                    {
                        canfire = true;
                    }
                ...
                case 3:
                    ...
                    if (rangedTank.isPacked && rangedTank.wantMove)
                    {
                        ...
                        if (Keyboard.GetState().IsKeyDown(Main.keyMap.getKey(2, 0)) && rangedTank.engineHeat > 0 || GamePad.GetState(PlayerIndex.Two).ThumbSticks.Left.Y > 0)
                        {
                            rangedTank.engineHeat -= 5;
                            rangedTank.MoveChassis();
                            rangedTank.engineHeat--;
                        }
                        else if (Keyboard.GetState().IsKeyDown(Main.keyMap.getKey(2, 1)) && rangedTank.engineHeat > 0 || GamePad.GetState(PlayerIndex.Two).ThumbSticks.Left.Y < 0)
                        {
                            rangedTank.engineHeat -= 5;
