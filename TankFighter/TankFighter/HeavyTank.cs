...
namespace TankFighter
{
    ...
    public class HeavyTank : Tank
    {
        ...
        public HeavyTank(int range, int xPos, int yPos)
        {
            firePower = 2;
            screenposChassis.X = xPos;
            screenposChassis.Y = yPos;
            firingCooldownMax = 125;
        ...
        public void LoadContent(GraphicsDevice graphics,ContentManager Content)
        {
            ...
            actual = graphics;
            chassis = Content.Load<Texture2D>("Heavy_Tank_Base");
            turret = Content.Load<Texture2D>("Heavy_Tank_Turret");
            screenposTurret.X = screenposChassis.X + 5;
            ...
            movement = Content.Load<SoundEffect>("Tank_Movement_Heavy");
            turretTurn = Content.Load<SoundEffect>("turretHeavy");
